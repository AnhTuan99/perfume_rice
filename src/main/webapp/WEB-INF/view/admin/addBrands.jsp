			...
			<div id="content-container">
				...
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Nhãn Hàng</h3>
					</div>


					<!-- BASIC FORM ELEMENTS -->
					<!--===================================================-->
					<sf:form method="post" action="/admin/addBrands" modelAttribute="brands" enctype="multipart/form-data" class="panel-body form-horizontal form-padding">
						<sf:hidden path="id" />
						<!--Static-->
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="name" autocomplete="off" type="text"
										  class="form-control" id="name" placeholder="Hãy nhập tên"
						...
						<!--Giá Input-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="txtDescription">Mô
								tả</label>
							<div class="col-md-9">
								<sf:textarea autocomplete="off" path="description"
											 class="form-control" placeholder="Mô tả"
											 id="txtDescription" rows="3" required="required"></sf:textarea><small class="help-block">Hãy
									mô tả</small>
							</div>
						</div>

						<div class="form-group">
							<label class="col-md-3 control-label" for="fileBrandsAvatar">Avatar</label>
							<div class="col-md-9">
								<input
										id="fileBrandsAvatar" name="brandsAvatar" type="file"
						...
						<div class="tab-footer clearfix">
							<div class="col-lg-7 col-lg-offset-3">
								<a href="/admin/listBrands" class="btn btn-secondary active"
