		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<div class="panel">
					...
					<!-- BASIC FORM ELEMENTS -->
					<!--===================================================-->
					<sf:form method="post" action="/admin/addContact" modelAttribute="contacts" enctype="multipart/form-data" class="panel-body form-horizontal form-padding">
						<sf:hidden path="id" />
						<!--Static-->
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="first_name" autocomplete="off" type="text"
										  class="form-control" id="nafirst_nameme" placeholder="Hãy họ"
										  required="required"></sf:input><small
									class="help-block">Hãy họ</small>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="last_name" autocomplete="off" type="text"
										  class="form-control" id="last_name" placeholder="Hãy nhập tên"
										  required="required"></sf:input><small
									class="help-block">Hãy nhập tên</small>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="email" autocomplete="off" type="text"
										  class="form-control" id="email" placeholder="Hãy nhập email"
										  required="required"></sf:input><small
									class="help-block">Hãy nhập email</small>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="telephone" autocomplete="off" type="text"
										  class="form-control" id="telephone" placeholder="Hãy nhập số điện thoại"
										  required="required"></sf:input><small
									class="help-block">Hãy nhập số điện thoại</small>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="address" autocomplete="off" type="text"
										  class="form-control" id="address" placeholder="Hãy nhập địa chỉ"
										  required="required"></sf:input><small
									class="help-block">Hãy nhập địa chỉ</small>
							</div>
						</div>
						...
						<!--Mess Input-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="description">Bình Luận</label>
							<div class="col-md-9">
								<sf:textarea autocomplete="off" path="message"
											 class="form-control" placeholder="Bình luận"
											 id="message" rows="3" required="required"></sf:textarea><small class="help-block">Hãy
									nhập bình luận</small>
							</div>
						</div>
						...
						<div class="tab-footer clearfix">
							<div class="col-lg-7 col-lg-offset-3">
								<a href="/admin/listContact" class="btn btn-secondary active"
								   role="button" aria-pressed="true">Quay lại</a>
								<button type="submit"
										class="btn btn-primary btn-labeled fa fa-check fa-lg">Xác nhận</button>
