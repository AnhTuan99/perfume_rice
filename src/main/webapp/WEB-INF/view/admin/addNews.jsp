		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<div class="panel">
					...
					<!-- BASIC FORM ELEMENTS -->
					<!--===================================================-->
					<sf:form method="post" action="/admin/addNews" modelAttribute="news" enctype="multipart/form-data" class="panel-body form-horizontal form-padding">
						<sf:hidden path="id" />
						<!--Static-->
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="title" autocomplete="off" type="text"
										  class="form-control" id="name" placeholder="Hãy nhập tiêu đề"
						...
						<!--ShortNews Input-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="demo-email-input">Tin tức ngắn</label>
							<div class="col-md-9">
								<sf:textarea autocomplete="off" path="short_news"
											 class="form-control" placeholder="Tin tức ngắn"
											 id="txtShortNews" rows="3" required="required"></sf:textarea><small class="help-block">Hãy
									nhập tin tức ngắn</small>
							</div>
						</div>

						<!--News Input-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="demo-email-input">Tin tức chi tiết</label>
							<div class="col-md-9">
								<sf:textarea autocomplete="off" path="news"
											 class="form-control" placeholder="Tin tức chi tiết"
											 id="txtNews" rows="3" required="required"></sf:textarea><small class="help-block">Hãy
								nhập tiêu tin tức chi tiết</small>
							</div>
						</div>

						<div class="form-group">
							<label class="col-md-3 control-label" for="fileNewsAvatar">Avatar</label>
							<div class="col-md-9">
								<input
										id="fileNewsAvatar" name="newsAvatar" type="file"
						...
						<div class="tab-footer clearfix">
							<div class="col-lg-7 col-lg-offset-3">
								<a href="/admin/listNews" class="btn btn-secondary active"
