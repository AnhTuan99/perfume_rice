		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<div class="panel">
					...
					<!-- BASIC FORM ELEMENTS -->
					<!--===================================================-->
					<sf:form method="post" action="/admin/addProduct" modelAttribute="product" enctype="multipart/form-data" class="panel-body form-horizontal form-padding">
						<sf:hidden path="id" />
						<!--Static-->
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:select class="col-md-9 form-control" path="categories.id"  id="category">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:select class="col-md-9 form-control" path="brands.id"  id="brands">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="title" autocomplete="off" type="text"
										  class="form-control" id="Hãy nhập tiêu đề" placeholder="Title"
										  required="required"></sf:input><small
									class="help-block">Hãy tiêu đề</small>
							</div>
						</div>

						<!--Giá Input-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="demo-email-input">Giá</label>
							<div class="col-md-9">
								<sf:input type="number" autocomplete="off" path="price"
										  class="form-control" id="price" placeholder="Hãy nhập giá"
										  required="required"></sf:input> <small
									class="help-block">Hãy nhập giá</small>
							</div>
						</div>

						<!--Số lượng-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="demo-password-input">Số
								lượng</label>
							<div class="col-md-9">
								<sf:input type="number" autocomplete="off" path="amount"
										  class="form-control" id="amount" placeholder="Hãy nhập số lượng"
										  required="required"></sf:input> <small
									class="help-block">Hãy nhập số lượng</small>
							</div>
						</div>

						<!--Giảm giá Input-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="demo-password-input">Giảm giá</label>
							<div class="col-md-9">
								<sf:input type="number" autocomplete="off" path="saleoff"
										  class="form-control" id="saleoff" placeholder="Hãy nhập phần trăm giảm giá"
										  required="required"></sf:input> <small
									class="help-block">Hãy nhập phần trăm giảm giá</small>
							</div>
						</div>

						<!--Textarea-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="demo-textarea-input">Mô
								tả ngắn</label>
							<div class="col-md-9">
								<sf:textarea  autocomplete="off" path="short_description"
											 class="form-control" placeholder="Mô tả ngắn"
											 id="txtShortlDescription" rows="3" required="required"></sf:textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:textarea autocomplete="off" path="detail_description"
											 class="form-control summernote" placeholder="Mô tả chi tiết" id="txtDetailDescription" rows="3"
											 required="required"></sf:textarea>
							</div>
						</div>

						<div class="form-group form-check">
							<label class="col-md-3 control-label" for="isHot">Sản phẩm Hot?</label>
							<div class="col-md-9">
						...
						<div class="form-group">
							<label class="col-md-3 control-label" for="fileProductAvatar">Avatar</label>
							<div class="col-md-9">
								<input
						...
						<div class="form-group">
							<label class="col-md-3 control-label" for="fileProductPictures">Picture(Multiple)</label>
							<div class="col-md-9">
								<input
										id="fileProductPictures" name="productPictures" type="file"
										class="form-control-file" multiple="multiple" 1>
							</div>
						</div>

						<div class="tab-footer clearfix">
							<div class="col-lg-7 col-lg-offset-3">
								<a href="/admin/listProducts" class="btn btn-secondary active"
								   role="button" aria-pr6essed="true">Quay lại</a>

									<button type="submit" class="btn btn-primary btn-labeled fa fa-check fa-lg">Xác nhận</button>
								...
								<div class="tab-pane fade" id="demo-asd-tab-2">
									...
									<div class="list-group bg-trans">
										<a href="#" class="list-group-item"><span
											...
											class="list-group-item">Transfer Funds</a>
									</div>
