		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<div class="panel">
					...
					<!-- BASIC FORM ELEMENTS -->
					<!--===================================================-->
					<sf:form method="post" action="/admin/addProductImages/${idProduct}" modelAttribute="productsImages" enctype="multipart/form-data" class="panel-body form-horizontal form-padding">
						<sf:hidden path="id" />
						<!--Static-->
						...
						<div class="form-group">
							<label class="col-md-3 control-label" for="fileProductsImages">Ảnh</label>
							<div class="col-md-9">
								<input
										id="fileProductsImages" name="imagesPro" type="file"
						...
						<div class="tab-footer clearfix">
							<div class="col-lg-7 col-lg-offset-3">
								<a href="/admin/listProductsImages/${idProduct}" class="btn btn-secondary active"
