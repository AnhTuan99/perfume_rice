			...
			<div id="content-container">
				...
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Quyền</h3>
					</div>


					<!-- BASIC FORM ELEMENTS -->
					<!--===================================================-->
					<sf:form method="post" action="/admin/addUsers" modelAttribute="users" enctype="multipart/form-data" class="panel-body form-horizontal form-padding">
						<sf:hidden path="id" />
						<!--Static-->
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="fullName" autocomplete="off" type="text"
										  class="form-control" id="fullName" placeholder="Hãy nhập họ tên"
										  required="required"></sf:input><small
									class="help-block">Hãy nhập họ tên</small>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input path="username" autocomplete="off" type="text"
										  class="form-control" id="username" placeholder="Hãy nhập tài khoản"
										  required="required"></sf:input><small
									class="help-block">Hãy nhập tài khoản</small>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<sf:input required="autofocus" path="password" autocomplete="off" type="password"
										  class="form-control" id="password" placeholder="Hãy nhập mật khẩu"
										  ></sf:input><small
									class="help-block">Hãy nhập mật khẩu</small>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="password" required oninput="checkPasswordMatch(this);" autocomplete="off" type="text"
										  class="form-control" placeholder="Hãy nhập lại mật khẩu"
										  required="required"></input><small
									class="help-block">Hãy nhập lại mật khẩu</small>
							</div>
						</div>
						...
						<div class="tab-footer clearfix">
							<div class="col-lg-7 col-lg-offset-3">
								<a href="/admin/listUsers" class="btn btn-secondary active"
