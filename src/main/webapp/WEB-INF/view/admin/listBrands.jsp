        ...
        <div id="content-container">
            ...
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Quản Lý Nhãn Hàng</h3>
                </div>
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 table-toolbar-left">
                                <a href="/admin/addBrands">
                                    <button id="demo-btn-addrow" class="btn btn-purple btn-labeled fa fa-plus">Thêm nhãn hàng
                                    </button>
                                </a>
                    ...
                    <div class="table-responsive">
                        <form method="post" action="/admin/listBrands">
                            <table class="table table-striped table-hover">
                                ...
                                <c:forEach var="brand" items="${brands }" varStatus="loop">
                                    <tr class="tr-shadow">
                                        ...
                                        <td style="font-size: 16px;">${brand.name}</td>
                                        <td><img style="width: 70px; height: 90px;" class="card-img-top" src="/upload/${brand.avatar}" alt=""></td>
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-xs btn-default add-tooltip"
                                               data-toggle="tooltip" href="/admin/updateBrands/${brand.id}" data-original-title="Edit"
                                               data-container="body">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a class="btn btn-xs btn-danger add-tooltip"
                                               data-toggle="tooltip" href="#" data-original-title="Delete" onclick="deleteBrands(${brand.id});"
                                               data-container="body">
