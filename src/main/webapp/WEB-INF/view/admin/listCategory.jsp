                        ...
                        <div class="row">
                            <div class="col-sm-6 table-toolbar-left">
                                <a href="/admin/addCategory">
                                    <button id="demo-btn-addrow" class="btn btn-purple btn-labeled fa fa-plus">Thêm danh mục
                                    </button>
                                </a>
                                    ...
                                    <tr class="tr-shadow">
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-xs btn-default add-tooltip"
                                               data-toggle="tooltip" href="/admin/updateCategory/${category.id}" data-original-title="Edit"
                                               data-container="body">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a class="btn btn-xs btn-danger add-tooltip"
                                               data-toggle="tooltip" href="#" data-original-title="Delete" onclick="deleteCategory(${category.id});"
                                               data-container="body">
