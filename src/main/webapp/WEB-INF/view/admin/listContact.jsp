                    ...
                    <div class="pad-btm form-inline">
                        <div class="row">
                            <div class="col-sm-6 table-toolbar-left">
                                <a href="/admin/addContact">
                                    <button id="demo-btn-addrow" class="btn btn-purple btn-labeled fa fa-plus">Thêm liên hệ
                                    </button>
                                </a>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <c:forEach var="contact" items="${contacts }" varStatus="loop">
                                    <tr class="tr-shadow">
                                        ...
                                        <td style="font-size: 16px;">${contact.first_name}</td>
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-xs btn-default add-tooltip"
                                               data-toggle="tooltip" href="/admin/updateContact/${contact.id}" data-original-title="Edit"
                                               data-container="body">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a class="btn btn-xs btn-danger add-tooltip"
                                               data-toggle="tooltip" href="#" data-original-title="Delete" onclick="deleteContact(${contact.id});"
                                               data-container="body">
