                        ...
                        <div class="row">
                            <div class="col-sm-6 table-toolbar-left">
                                <a href="/admin/addNews">
                                    <button id="demo-btn-addrow" class="btn btn-purple btn-labeled fa fa-plus">Thêm tin tức
                                    </button>
                                </a>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <c:forEach var="n" items="${news }" varStatus="loop">
                                    <tr class="tr-shadow">
                                        ...
                                        <td style="font-size: 16px;">${n.title}</td>
                                        <td><img style="width: 70px; height: 90px;" class="card-img-top" src="/upload/${n.avatar}" alt=""></td>
                                        <td>${n.short_news}</td>
                                        <td>${n.news}</td>
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-xs btn-default add-tooltip"
                                               data-toggle="tooltip" href="/admin/updateNews/${n.id}" data-original-title="Edit"
                                               data-container="body">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a class="btn btn-xs btn-danger add-tooltip"
                                               data-toggle="tooltip" href="#" data-original-title="Delete" onclick="deleteNews(${n.id});"
                                               data-container="body">
