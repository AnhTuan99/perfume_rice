							...
							<div class="row">
								<div class="col-sm-6 table-toolbar-left">
									<a href="/admin/addProduct" >
										<button  id="demo-btn-addrow" class="btn btn-purple btn-labeled fa fa-plus">Thêm sản phẩm</button>
									</a>
								...
								<tbody id="myTable">
									<c:forEach var="p" items="${product }" varStatus="loop">
										<tr class="tr-shadow">
											...
											<td><img style="width: 70px; height: 90px;" class="card-img-top" src="/upload/${p.avatar}" alt=""></td>
											...
											<td class="text-right">
												<a class="btn btn-xs btn-default add-tooltip"
												   data-toggle="tooltip" href="/admin/listProductsImages/${p.id}" data-original-title="List Products Images"
												   data-container="body">
													<i class="fa fa-file-image-o" aria-hidden="true"></i>
												</a>
												<a class="btn btn-xs btn-default add-tooltip"
												   data-toggle="tooltip" href="/admin/updateProduct/${p.id}" data-original-title="Edit"
												   data-container="body">
													<i class="fa fa-pencil"></i>
												</a>
												<a class="btn btn-xs btn-danger add-tooltip"
												   data-toggle="tooltip" href="#" data-original-title="Delete" onclick="deleteProduct(${p.id});"
												   data-container="body">
