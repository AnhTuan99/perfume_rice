					...
					<div class="panel-body">
						<div class="pad-btm form-inline">
							<div class="row">
								<div class="col-sm-6 table-toolbar-left">
									<a href="/admin/addProductImages/${idProduct}" >
										<button  id="demo-btn-addrow" class="btn btn-purple btn-labeled fa fa-plus">Thêm ảnh sản phẩm</button>
									</a>
						...
						<div class="table-responsive">
							<table class="table table-striped table-hover">
								...
								<tbody id="myTable">
									<c:forEach var="p" items="${productsImages }" varStatus="loop">
										<tr class="tr-shadow">
											<th scope="row">${loop.index + 1}</th>
											<td style="font-size: 16px;">${p.title}</td>
											<td><img style="width: 70px; height: 90px;" class="card-img-top" src="/upload/${p.path}" alt=""></td>
											...
											<td class="text-right">
												<a class="btn btn-xs btn-default add-tooltip"
												   data-toggle="tooltip" href="/admin/updateProductsImages/${p.id}?idProduct=${idProduct}" data-original-title="Edit"
												   data-container="body">
													<i class="fa fa-pencil"></i>
												</a>
												<a class="btn btn-xs btn-danger add-tooltip"
												   data-toggle="tooltip" href="#" data-original-title="Delete" onclick="deleteProductsImages(${p.id});"
												   data-container="body">
