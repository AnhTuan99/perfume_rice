            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="pad-btm form-inline">
                        <div class="row">
                            <div class="col-sm-6 table-toolbar-left">
                                <a href="/admin/addUsers">
                                    <button id="demo-btn-addrow" class="btn btn-purple btn-labeled fa fa-plus">Thêm người dùng
                                    </button>
                                </a>
                    ...
                    <div class="table-responsive">
                        <form method="post" action="/admin/listUsers">
                            <table class="table table-striped table-hover">
                                ...
                                <c:forEach var="u" items="${users }" varStatus="loop">
                                    <tr class="tr-shadow">
                                        ...
                                        <td style="font-size: 16px;">${u.username}</td>
                                        <td style="font-size: 16px;">${u.password}</td>
                                        <td>${u.fullName}</td>
                                        <td>${u.email}</td>
                                        ...
                                        <td class="text-right">
                                            <%-- <a class="btn btn-xs btn-default add-tooltip"
                                               data-toggle="tooltip" href="/admin/updateUsers/${u.id}" data-original-title="Edit"
                                               data-container="body">
                                                <i class="fa fa-pencil"></i>
                                            </a> --%>
                                            <a class="btn btn-xs btn-danger add-tooltip"
                                               data-toggle="tooltip" href="#" data-original-title="Delete" onclick="deleteUsers(${u.id});"
                                               data-container="body">
