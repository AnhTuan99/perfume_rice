		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<div class="panel">
					...
					<!--===================================================-->
					<sf:form method="POST" action="/admin/profile" modelAttribute="users" id="demo-bv-accordion" class="form-horizontal">
						<sf:hidden path="id" />
							...
							<div class="panel-heading">
								<div class="panel-control">
									<ul class="nav nav-tabs">
										<li class="active"><a data-toggle="tab" href="#demo-tabs-box-1"><i class="fa"></i> Tài khoản</a></li>
										<li><a data-toggle="tab" href="#demo-tabs-box-2"><i class="fa"></i> Đổi mật khẩu</a></li>
										<li><a data-toggle="tab" href="#demo-tabs-box-3"><i class="fa"></i> Thông tin</a></li>
									</ul>
								</div>
								<h3 class="panel-title">Thông tin của tôi</h3>
							</div>
								...
								<div class="panel-body">
									<div class="tab-content">
										...
										<div id="demo-tabs-box-1" class="tab-pane fade in active">
											<h4 class="mar-btm text-thin">Tài khoản</h4>
											<hr>
											...
											<div class="form-group">
												<div class="col-lg-7 col-lg-offset-3">
													<button type="submit" class="btn btn-primary btn-labeled fa fa-user fa-lg" value="Sign up">Cập nhật tài khoản và đăng nhập lại</button>
												</div>
											</div>
										</div>
										<!--===================================================-->
										...
										<!--===================================================-->
										<form method="POST" action="/admin/profileUpdatePass" name="registration" id="registration">
											<div id="demo-tabs-box-2" class="tab-pane fade">
												<h4 class="mar-btm text-thin">Đổi mật khẩu</h4>
												<hr>
												<div class="form-group">
												...
												<div class="form-group">
													<div class="col-lg-7 col-lg-offset-3">
														<button onclick="updatePass();" type="button" class="btn btn-primary btn-labeled fa fa-user fa-lg" value="Sign up">Cập nhật mật khẩu và đăng nhập lại</button>
													</div>
												</div>
											</div>
										</form>
										...
										<div id="demo-tabs-box-3" class="tab-pane fade">
											<h4 class="mar-btm text-thin">Thông tin</h4>
											<hr>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-lg-7">
													<sf:input required="required"  path="telephone" type="number" class="form-control" name="phoneNumber" placeholder="Điện thoại"/>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<div class="col-lg-7 col-lg-offset-3">
													<button type="submit" class="btn btn-primary btn-labeled fa fa-user fa-lg" name="signup" value="Sign up">Cập nhật thông tin và đăng nhập lại</button>
												</div>
											</div>
											<div class="form-group">
												<div class="col-lg-7 col-lg-offset-3">
