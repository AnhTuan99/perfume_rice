            ...
            <div class="toolbar">
              <div class="sorter">
                <div class="view-mode">
                  ...
                  <c:choose>
                    <c:when test="${empty categoriesName}">
                      <a href="/category/${'all'}" title="List" class="button-list">&nbsp;</a>
                    </c:when>
                    <c:otherwise>
                      <a href="/category/${categoriesName.id}" title="Grid" class="button button-grid">&nbsp;</a>&nbsp;
                    </c:otherwise>
                  </c:choose>
                  ...
                  <c:choose>
                    ...
                    <ul>
                      ...
                      <li><a href="/category/${idCategories}?sortby=createddesc">Hàng cũ nhất</a></li>--%>
                        ...
                        <c:choose>
                          <c:when test="${empty categoriesName}">
                            <li style="width: 150px"><a href="/listCategory/${'all'}/${'macdinh'}">Mặt định</a></li>
                            <li style="width: 150px"><a href="/listCategory/${'all'}/${'nameasc'}">A -> Z</a></li>
                            <li style="width: 150px"><a href="/listCategory/${'all'}/${'namedesc'}">Z -> A</a></li>
                            <li style="width: 150px"><a href="/listCategory/${'all'}/${'priceasc'}">Giá tăng dần</a></li>
                            <li style="width: 150px"><a href="/listCategory/${'all'}/${'pricedesc'}">Giá giảm dần</a></li>
                            <li style="width: 150px"><a href="/listCategory/${'all'}/${'createdasc'}">Hàng mới nhất</a></li>
                            <li style="width: 150px"><a href="/listCategory/${'all'}/${'createddesc'}">Hàng cũ nhất</a></li>
                          </c:when>
                          <c:otherwise>
                            <li style="width: 150px"><a href="/listCategory/${idCategories}/${'macdinh'}">Mặt định</a></li>
                            <li style="width: 150px"><a href="/listCategory/${idCategories}/${'nameasc'}">A -> Z</a></li>
                            <li style="width: 150px"><a href="/listCategory/${idCategories}/${'namedesc'}">Z -> A</a></li>
                            <li style="width: 150px"><a href="/listCategory/${idCategories}/${'priceasc'}">Giá tăng dần</a></li>
                            <li style="width: 150px"><a href="/listCategory/${idCategories}/${'pricedesc'}">Giá giảm dần</a></li>
                            <li style="width: 150px"><a href="/listCategory/${idCategories}/${'createdasc'}">Hàng mới nhất</a></li>
                            <li style="width: 150px"><a href="/listCategory/${idCategories}/${'createddesc'}">Hàng cũ nhất</a></li>
                          </c:otherwise>
                        </c:choose>
                    </ul>
                  </li>
                ...
                <c:forEach items="${product}" var="p">
                  ...
                  <li class="item first">
                    <div class="product-image">
                      <a href="/detailProducts/${p.id}" title="${p.title}">
                        <img class="small-image" src="/upload/${p.avatar }" alt="Sample Product">
                      </a>
                    </div>

                    <div class="product-shop">
                      <h2 class="product-name">
                        <a href="/detailProducts/${p.id}" title="${p.title}">${p.title }</a>
                      </h2>
                    <%--  <div class="ratings">
                        ...
                        <p class="rating-links">
                          <a href="#/review/product/list/id/167/category/35/">1 Đánh Giá</a>
                          <span class="separator">|</span>
                          <a href="#review-form">Thêm Đánh Giá Của Bạn</a>
                        </p>
                      </div>--%>
                      <div class="desc std">
                        <p>${p.short_description}
                          <a class="link-learn" title="" href="/detailProducts/${p.id}">Tìm Hiểu Thêm</a>
                        </p>
                      </div>
                      <div class="price-box">
                        <c:choose>
                          ...
                          <c:otherwise>
                            <p class="old-price">
                              <span class="price-label"></span>
                              <span id="old-price-21" class="price">
                                <fmt:setLocale value="vi_VN" scope="session" />
                                <fmt:formatNumber value="${p.price }" type="currency" />
                              </span>
                            </p>
                      ...
                      <div class="actions">
                        <button onclick="order.chon_san_pham_dua_vao_gio_hang(${p.id}, 1);" class="button btn-cart ajx-cart" title="Add to Cart" type="button">
                          <span>Thêm Vào Giỏ</span>
                        </button>
                        <%--<span class="add-to-links">
                          <a title="Add to Wishlist" class="button link-wishlist" href="wishlist.html">
                            <span>Add to Wishlist</span>
                          </a>
                          <a title="Add to Compare" class="button link-compare" href="compare.html">
