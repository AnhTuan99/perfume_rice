...
$(document).ready(function() {
	...
	$('#demo-bv-accordion').bootstrapValidator({
		...
		username: {
			...
			validators: {
				notEmpty: {
					message: 'Tên người dùng là bắt buộc và không được để trống'
				},
				stringLength: {
					min: 4,
					max: 30,
					message: 'Tên người dùng phải dài hơn 4 và dưới 30 ký tự'
				},
				regexp: {
					regexp: /^[a-zA-Z0-9_\.]+$/,
					message: 'Tên người dùng chỉ có thể bao gồm bảng chữ cái, số, dấu chấm và dấu gạch dưới'
				},
				different: {
					field: 'password',
					message: 'Tên người dùng và mật khẩu không được giống nhau'
				}
			}
		},
		email: {
			validators: {
				notEmpty: {
					message: 'Địa chỉ email là bắt buộc và không được để trống'
				},
				emailAddress: {
					message: 'Đầu vào không phải là một địa chỉ email hợp lệ'
				}
			}
		},
		password: {
	...
	$('#demo-bv-errorcnt').bootstrapValidator({
		...
		phoneNumber: {
			...
			validators: {
				notEmpty: {
					message: 'Số điện thoại là bắt buộc và không được để trống'
				},
				digits: {
					message: 'Giá trị chỉ có thể chứa các chữ số'
				}
				}
		},
		city:{
		...
		greaterthan: {
			validators: {
				...
				greaterThan: {
					...
					value: 50,
					message: 'Vui lòng nhập giá trị lớn hơn 50'
				}
			}
		},
		lessthan: {
			validators: {
				...
				lessThan: {
					...
					value: 25,
					message: 'Vui lòng nhập giá trị lớn hơn 25'
				}
			}
		},
		range: {
